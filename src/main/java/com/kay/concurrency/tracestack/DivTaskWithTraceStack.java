...
/**
 * Created by kay on 2017/9/4. 执行方式改为 execute,此时执行错误会有 异常在哪抛出的信息：注意：但是不知道异常在哪里提交出来的（从哪进入) Exception
 * in thread "pool-1-thread-1" java.lang.ArithmeticException: / by zero at
 * com.kay.concurrent.tracestack.DivTaskWithTraceStack.run(DivTaskWithTraceStack.java:20) at
