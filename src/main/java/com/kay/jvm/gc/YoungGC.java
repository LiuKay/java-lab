...
/**
 * VM Args: -Xms20M -Xmx20M -Xmn10M -XX:+UseSerialGC -XX:+PrintGCDetails -XX:SurvivorRatio=8 -XX:+PrintCommandLineFlags
 *
 * [GC (Allocation Failure) [DefNew: 8159K->459K(9216K), 0.0037467 secs] 8159K->6603K(19456K), 0.0037839 secs] [Times: user=0.00 sys=0.00, real=0.00 secs]
 * Heap
 ...
 *   from space 1024K,  44% used [0x00000000ff500000, 0x00000000ff572e18, 0x00000000ff600000)
